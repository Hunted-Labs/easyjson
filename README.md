# easyjson [![Build Status](https://github.com/Hunted-Labs/easyjson/actions/workflows/easyjson.yml/badge.svg)](https://github.com/Hunted-Labs/easyjson/actions/workflows/easyjson.yml) [![Go Report Card](https://goreportcard.com/badge/github.com/Hunted-Labs/easyjson)](https://goreportcard.com/report/github.com/Hunted-Labs/easyjson)
...
```sh
# for Go < 1.17
go get -u github.com/Hunted-Labs/easyjson/...
```
#### or
```sh
# for Go >= 1.17
go get github.com/Hunted-Labs/easyjson && go install github.com/Hunted-Labs/easyjson/...@latest
```
### Run:
```sh
...
Please see the [GoDoc](https://godoc.org/github.com/Hunted-Labs/easyjson)
...
listing](https://godoc.org/github.com/Hunted-Labs/easyjson) for the full listing of
...
Please see the [GoDoc listing](https://godoc.org/github.com/Hunted-Labs/easyjson/buffer)
